              ...
              Row(
                ...
                children: <Widget>[
                  Padding(
                      ...
                      child: Text(
                        '${resultData.pct_mbmi.toStringAsFixed(1)} %',
                        style: TextStyle(
                            color: Colors.red,
                            fontSize: 48.0
                        ),
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              '${resultData.decimal_age.toStringAsFixed(1)} years',
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(0, 0, 50, 0),
                            child: Text(
                              '${resultData.height_sds.toStringAsFixed(1)}',
                              textAlign: TextAlign.right,
                              style: TextStyle(
                                  color: Colors.black87,
                                  fontWeight: FontWeight.w200,
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(0, 0, 50, 0),
                            child: Text(
                              '${resultData.weight_sds.toStringAsFixed(1)}',
                              textAlign: TextAlign.right,
                              style: TextStyle(
                                  color: Colors.black87,
                                  fontWeight: FontWeight.w200,
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(0, 0, 50, 0),
                            child: Text(
                              '${resultData.bmi_sds.toStringAsFixed(1)}',
                              textAlign: TextAlign.right,
                              style: TextStyle(
                                  color: Colors.black87,
                                  fontWeight: FontWeight.w200,
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        '${resultData.eighty_five_pct_weight.toStringAsFixed(1)} kg',
                                        textAlign: TextAlign.right,
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                        ),
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                      padding: EdgeInsets.fromLTRB(0, 20, 50, 10),
                                      child: Text(
                                        '${resultData.ninety_pct_weight.toStringAsFixed(1)} kg',
                                        textAlign: TextAlign.right,
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                        ),
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                      padding: EdgeInsets.fromLTRB(0, 20, 50, 10),
                                      child: Text(
                                        '${resultData.ninety_five_pct_weight.toStringAsFixed(1)} kg',
                                        textAlign: TextAlign.right,
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                        ),
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                      padding: EdgeInsets.fromLTRB(0, 20, 50, 10),
                                      child: Text(
                                        '${resultData.hundred_pct_weight.toStringAsFixed(1)} kg',
                                        textAlign: TextAlign.right,
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                        ),
