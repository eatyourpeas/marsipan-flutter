...
List<RiskCategory> marsipanCategories = [
  ...
  RiskCategory('BMI and weight', Icons.monitor_weight_outlined,
      marsipanRisks[4], marsipanRisks[5], marsipanRisks[6], marsipanRisks[7]),
  RiskCategory('HR (awake)', Icons.monitor_heart_outlined, marsipanRisks[8],
      marsipanRisks[9], marsipanRisks[10], marsipanRisks[11]),
  RiskCategory('Cardiovascular health', Icons.favorite, marsipanRisks[12],
      marsipanRisks[13], marsipanRisks[14], marsipanRisks[15]),
  RiskCategory('Hydration status', Icons.water_drop_outlined, marsipanRisks[16],
      marsipanRisks[17], marsipanRisks[18], marsipanRisks[19]),
  RiskCategory('Temperature', Icons.thermostat_outlined, marsipanRisks[20],
  ...
  RiskCategory(
      ...
      marsipanRisks[46],
      marsipanRisks[47]),
  RiskCategory('Haematology', Icons.bloodtype_outlined, marsipanRisks[48],
  ...
  RiskCategory(
      ...
      marsipanRisks[62],
      marsipanRisks[63]),
  RiskCategory('Purging behaviours', Icons.no_food_outlined, marsipanRisks[64],
      marsipanRisks[65], marsipanRisks[66], marsipanRisks[67]),
  RiskCategory('Self harm and suicide', Icons.storm_outlined, marsipanRisks[68],
      marsipanRisks[69], marsipanRisks[70], marsipanRisks[71]),
];
